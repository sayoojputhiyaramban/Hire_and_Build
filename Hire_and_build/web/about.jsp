...
<head>
	...
	<!-- Bootstrap-Core-CSS -->
	<!-- team deoslide -->
	<link rel="stylesheet" href="district-web_Free03-09-2018_876381332/web/css/jquery.desoslide.css">
...
<body>
						...
						<div class="col-xl-7 col-lg-6 header_agileits_left">
							<ul>
								...
								<li>
									...
									<a href="mailto:info@example.com">sayoojputhiyaramban@gmail.com</a>
								</li>
							</ul>
						</div>
		...
		<div class="container py-xl-5 py-lg-3">
			...
			<div class="row features-row">
				<div class="col-lg-5 features-right mt-3">
					<img src="district-web_Free03-09-2018_876381332/web/images/about.jpg" class="img-fluid" alt="" />
				</div>
	...
	<script src="district-web_Free03-09-2018_876381332/web/js/jquery.desoslide.js"></script>
	<script>
