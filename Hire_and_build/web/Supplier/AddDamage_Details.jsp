...
<body>
	...
	<div class="contact-w3l">
		<div class="container">
			<!-- tittle heading -->
			<h3 class="tittle-w3l">Add Damage Details
			...
			<div class="contact agileits">
				<div class="contact-agileinfo">
					<div class="contact-form wthree">
						<form action="../AddDamageAction?order_id=<%= request.getParameter("order_id")%>" method="post">
							<div class="">
                                                            
                                                     <textarea placeholder="Damage Details" name="txtdetails" id="txtdetails" required=""></textarea>
                         ...
                         <div class="">
							...
							<div class="">
								<input type="text" name="txtamount" id="txtamount" placeholder="Add rate for the damage" required="">
							</div>
                                                    <div class="">
                                                        Last Date of Payment<br>
								<input type="date" name="txtldate" id="txtldate" placeholder="" required="">
							</div>
