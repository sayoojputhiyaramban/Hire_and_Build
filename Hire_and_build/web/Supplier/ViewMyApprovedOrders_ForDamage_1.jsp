...
<body>
	...
	<div class="privacy">
		<div class="container">
			<!-- tittle heading -->
			<h3 class="tittle-w3l">View Damaged Orders
			...
			<div class="checkout-right">
				...
				<div class="table-responsive">
					<table class="timetable_sub">
                                            ...
                                            <%
                                                String sqlRequirements="select resourceorder_tb.* from resourceorder_tb inner join adddamage_details_tb on resourceorder_tb.order_id=adddamage_details_tb.order_id where supplier_id='"+session.getAttribute("id")+"' and status='Damaged' ";
							...
							<!--	<td class="invert">
									<div class="rem">
										<!--<div class="close1"> </div>-->
                                             ...
                                             <a href="ViewDamageDetails.jsp?order_id=<%=rsRequirements.getString(1)%>">About Order 
							
						</a> <br><br>
                                             
                                              <a href="CustomerDetails.jsp?customer_id=<%=rsRequirements.getString("customer_id")%>">About Customer 
							
						</a> 
                                             <!--<br><br>  <a href="../ApproveOrderAction?order_id=<%=rsRequirements.getString(1)%>&status=Rejected">Reject
