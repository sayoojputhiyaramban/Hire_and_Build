...
<body>
	...
	<div class="faqs-w3l">
		<div class="container">
			<!-- tittle heading -->
			<h3 class="tittle-w3l">View All Equipments and Add Available Stock
                        ...
                        {%>
                                      ...
                                      <tr>
                                          ...
                                          <td><img src="../admin/ResouceUploads/<%=rs.getString("Uploads")%>" alt="No image" width="140px" height="140px"/></td>
                                           <td><input type="checkbox" name="chk" id="chk" value="<%=rs.getString(1)%>" onclick='ResourceQuantityPopUp(this);'/></td>
