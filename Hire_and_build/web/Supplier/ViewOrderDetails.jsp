					...
					<table class="timetable_sub">
						...
						<thead>
							...
							<span class="fa fa-hand-o-right" aria-hidden="true"></span>
                                                         ...
                                                         <div class="checkout-right-basket">
                                             <a href="../ReturnedResourceAction?order_id=<%=rsRequirements.getString(1)%>">Return Now
							<span class="fa fa-hand-o-right" aria-hidden="true"></span>
						</a> 
				...
				<div class="contact-agileinfo">
					<div class="contact-form wthree">
						<form action="#" method="post">
                                                    ...
                                                    <%
                                                 String sqlCustomers="select * from customer_tb where customer_id='"+Customer_id+"' ";
                                                ...
                                                %>
                                                <h3 class="tittle-w3l"> Customer Details</h3>
							<div class="">
                                                            CustomerName :  <input type="text" name="name" value=" <%=rsCustomers.getString(2)%>" readonly="true" />
							</div>
							<div class="">
								Address : <textarea  name="message"  readonly="true" ><%=rsCustomers.getString(3)%>	</textarea>
							</div>
							<div class="">
								Email: <input class="email" type="email" name="email" value=" <%=rsCustomers.getString(5)%>"  readonly="true" />
							</div>
							<div class="">
								 Contact Number :  <input type="text" name="name" value=" <%=rsCustomers.getString(4)%>"readonly="true" />
							</div>
