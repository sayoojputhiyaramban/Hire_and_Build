...
<body>
	...
	<div class="privacy">
		<div class="container">
			<!-- tittle heading -->
			<h3 class="tittle-w3l">View Black List Users
			...
			<div class="checkout-right">
				...
				<div class="table-responsive">
					<table class="timetable_sub">
                                            ...
                                            <%
                                                String sqlBL="select customer_tb.*,blacklist_tb.*  from customer_tb  inner join blacklist_tb  on blacklist_tb.customer_id=customer_tb.customer_id  where supplier_id='"+session.getAttribute("id")+"' ";
						...
						<thead>
							...
							<tr class="rem1">
								<td class="invert"><%=rsBL.getString(2) %> </td>
                                                                <td class="invert"><%=rsBL.getString(4) %> </td>
                                                                   <td class="invert"><%=rsBL.getString(5) %> </td>
								...
								<td class="invert"><%=rsBL.getString("order_id") %></td>
                                                                <td class="invert"><%=rsBL.getString("date") %></td>
                                                                 <td class="invert">
									<div class="rem">
										<!--<div class="close1"> </div>-->
                                                                                <a href="../deleteBLUserAction?list_id=<%=rsBL.getString("list_id")%>" class="close1"></a>
									</div>
                                                                </td>
							
                                                                <td class="invert">
                                                                          <div class="checkout-right-basket">
                                             <a href="ViewBLOrder_DamageDetails.jsp?list_id=<%=rsBL.getString("list_id")%>&order_id=<%=rsBL.getString("order_id") %>">Details
