...
Smartphone Compatible web template, free webdesigns for Nokia, Samsung, LG, SonyEricsson, Motorola web design" />
	...
	<div class="privacy">
		<div class="container">
			<!-- tittle heading -->
			<h3 class="tittle-w3l">Customer Details
        ...
        <%
           ...
           String sqlRequirements="select * from customer_tb where customer_id='"+customer_id+"'";
                                            ...
                                            %>       
                                                ...
                                                <tbody>
                                                        ...
                                                        <tr> <td>Customer Name</td> <td> <%=rsRequirements.getString(2)%> </td></tr>
							<tr class="rem1">
                                                            <td>Address</td>
								...
								<td class="invert"><%=rsRequirements.getString(4) %> </td> </tr>
                                                                ...
                                                                <tr>
                                                                     <td>Emailid</td>
								<td class="invert"><%=rsRequirements.getString("emailid") %></td></tr>
                                                ...
                                                {
                                                    out.println("Customer List is empty");
                                                }
