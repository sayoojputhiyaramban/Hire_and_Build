<%-- 
    Document   : ViewMyReturnedOrders
    Created on : Apr 25, 2019, 10:47:04 AM
    Author     : Integos
--%>
...
<body>
	...
	<div class="privacy">
		<div class="container">
			<!-- tittle heading -->
			<h3 class="tittle-w3l">View Returned Orders
			...
			<div class="checkout-right">
				...
				<div class="table-responsive">
					<table class="timetable_sub">
                                            ...
                                            <%
                                                String sqlRequirements="select * from resourceorder_tb where supplier_id='"+session.getAttribute("id")+"' and status='Returned' order by order_id desc";
							...
							<!--	<td class="invert">
									<div class="rem">
										<!--<div class="close1"> </div>-->
                                             ...
                                             <a href="ViewOrderDetails.jsp?order_id=<%=rsRequirements.getString(1)%>">Click Here
