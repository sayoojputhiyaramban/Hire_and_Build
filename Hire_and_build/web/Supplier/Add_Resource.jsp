...
Smartphone Compatible web template, free webdesigns for Nokia, Samsung, LG, SonyEricsson, Motorola web design" />
   ...
   <script type="text/javascript">     
        function MataDataPopUp()
{
var id=document.getElementById("item_id").value;
window.open("Add_ResourceQuantity.jsp?id="+id,'_blank','width=500,height=300,top=80,left=100');
	...
	<!-- flexslider -->
	<link rel="stylesheet" href="../online_shoppy/web/css/flexslider.css" type="text/css" media="screen" />
	<!-- fonts -->
...
<body>
	...
	<div class="banner-bootom-w3-agileits">
		<div class="container">
			...
			<!-- //tittle heading -->
                         ...
                         <% String sql= "select * from addresoucemain_tb where Resource_id='"+request.getParameter("id")+"'";
			...
			<div class="col-md-5 single-right-left ">
				<div class="grid images_3_of_2">
					<div class="flexslider">
						<ul class="slides">
							<li data-thumb="../admin/ResouceUploads/<%=rs.getString("Uploads")%>">
								<div class="thumb-image">
									<img src="../admin/ResouceUploads/<%=rs.getString("Uploads")%>" data-imagezoom="true" class="img-responsive" alt=""> </div>
							</li>
							<li data-thumb="../admin/ResouceUploads/<%=rs.getString("Uploads")%>">
								<div class="thumb-image">
									<img src="../admin/ResouceUploads/<%=rs.getString("Uploads")%>" data-imagezoom="true" class="img-responsive" alt=""> </div>
			...
			<div class="col-md-7 single-right-left simpleCart_shelfItem">
				<h3><%=rs.getString("ResourceName")%> </h3>
				<div class="rating1">
				...
				<div class="occasion-cart">
					<div class="snipcart-details top_brand_home_details item_add single-item hvr-outline-out">
							...
							<fieldset>
								...
								<input type="hidden" name="item_id" id="item_id" value="<%=rs.getString("Resource_id")%>" /> <!--Zeeba aaaaPremium Basmati Rice - 5 KG-->
								<!--<input type="hidden" name="txtamount" value="" />
								<input type="hidden" name="discount_amount" value="1.00" />
								<input type="hidden" name="currency_code" value="USD" />
								<input type="hidden" name="return" value=" " />
								<input type="hidden" name="cancel_return" value=" " />-->
								<input type="submit" name="submit" value="Add to My Resource" class="button" onClick="MataDataPopUp()" />
							</fieldset>
				...
				<ul id="flexiselDemo1">
					...
					<li>
						<div class="w3l-specilamk">
							<div class="speioffer-agile">
								<a href="single2.html">
									<img src="../online_shoppy/web/images/s9.jpg" alt="">
								</a>
							</div>
							<div class="product-name-w3l">
								<h4>
	...
	<!-- imagezoom -->
	<script src="../online_shoppy/web/js/imagezoom.js"></script>
	<!-- //imagezoom -->

	<!-- FlexSlider -->
	<script src="../online_shoppy/web/js/jquery.flexslider.js"></script>
	<script>
	...
	<script src="../online_shoppy/web/js/jquery.flexisel.js"></script>
	<script>
		$(window).load(function () {
