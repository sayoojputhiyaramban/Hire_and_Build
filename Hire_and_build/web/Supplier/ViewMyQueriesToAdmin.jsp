<%-- 
    Document   : QueriesToAdmin
    Created on : Apr 17, 2019, 4:18:08 PM
    Author     : Integos
--%>
...
<body>
	...
	<div class="contact-w3l">
		<div class="container">
			<!-- tittle heading -->
			<h3 class="tittle-w3l">My Queries To Admin
			...
			<div class="contact agileits">
				<div class="contact-agileinfo">
					<div class="contact-form wthree">
						<form action="../QueriesToAdminAction" method="post">
							...
							<div class="">
                                                            ...
                                                            <%
                                                                  String sql="select * from queries_to_admin_tb where supplier_id='"+session.getAttribute("id")+"'";
                                                ...
                                                <tr>
                                                                    ...
                                                                    <td><%= rs.getString(4) %></td>
                                                                     <td><%= rs.getString(5) %></td>
                                                                       ...
                                                                       <%
                                                     String sqlReply="select * from queries_reply_tb where query_id='"+rs.getString(1)+"'";
                                                     ResultSet rsReply=dm.ForSelect(sqlReply);
                                            if(rsReply.next())
                                            {
                                                    %>
                                                    
                                                    <td ><%= rsReply.getString(3) %> "replied on" <%= rsReply.getString(4) %></td>
