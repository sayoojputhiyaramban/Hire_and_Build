...
<body>
	...
	<div class="contact-w3l">
		<div class="container">
			<!-- tittle heading -->
			<h3 class="tittle-w3l">Add Queries To Admin
				...
				<div class="contact-agileinfo">
					<div class="contact-form wthree">
						<form action="../QueriesToAdminAction" method="post">
							...
							<div class="">                                                   
                         <input type="text" name="txtabout" id="txtabout" placeholder="About" required="" /> 
                         
							</div>
                         <div class="">
                           <textarea class="form-control" name="txtdetails" id="txtdetails" placeholder="Details" required=""></textarea>
                         </div>
							<div class="">
