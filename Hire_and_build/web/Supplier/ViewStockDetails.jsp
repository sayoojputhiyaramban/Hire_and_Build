<%-- 
    Document   : ViewStockDetails
    Created on : Apr 18, 2019, 11:05:18 AM
    Author     : Integos
--%>
...
Smartphone Compatible web template, free webdesigns for Nokia, Samsung, LG, SonyEricsson, Motorola web design" />
	<script>
        ...
        function ResourceQuantityPopUp(obj)
{
//var id=document.getElementById("hdnId").value;
//alert(obj.value);
window.open("Add_ResourceQuantity.jsp?id="+obj.value,'_blank','width=500,height=150,top=180,left=100');
...
<body>
	...
	<div class="faqs-w3l">
		<div class="container">
			<!-- tittle heading -->
			<h3 class="tittle-w3l">View My Available Stock 
			...
			<!--<div class="faq-w3agile">-->
                         ...
                         String sqlResource="select * from add_supplier_resource_tb where supplier_id='"+session.getAttribute("id")+"' ";
                        ResultSet rsResource=dm.ForSelect(sqlResource);
                        if(rsResource.next())
                        {%>
                             ...
                             <table cellspacing="15" cellpadding="10">
                                  ...
                                  <tr>
                                      ...
                                      <th>Name </th>
                                       <th>Details </th>
                                        <th>Resource </th>
                                       <th>Stock <br>Available  </th>
                                        <th>Amount <br>(Per Day) </th>
                                         <th>Travel Cost<br> (Per KM) </th>
                        ...
                        <%
                        rsResource.beforeFirst();
                        while(rsResource.next())
                        {
                                         
                        String sql="select * from addresoucemain_tb where Resource_id='"+rsResource.getString(5)+"' ";
                        ...
                        if(rs.next())
                        {
                              ...
                              %>
                                      ...
                                      <tr>
                                          ...
                                          <td><img src="../admin/ResouceUploads/<%=rs.getString("Uploads")%>" alt="No image" width="140px" height="140px"/></td>
                                           <td> <%=rsResource.getString(2)%></td>   
                                           <td> <%=rsResource.getString(3)%></td>
                                           <td> <%=rsResource.getString(4)%></td>
                                           
                                           <td><a href="EditStockDetails.jsp?id=<%=rsResource.getString(1)%>">Edit</a> </td>
                                           <td>&nbsp; &nbsp;</td>
                                            <td><a href="../DeleteStockAction?id=<%=rsResource.getString(1)%>">Delete</a> </td>
	...
	<div class="copy-right">
		<div class="container">
                    <p>© HIRE AND BUILD | by SAYOOJ P </p>
