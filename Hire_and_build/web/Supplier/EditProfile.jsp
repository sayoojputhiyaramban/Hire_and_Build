<%-- 
    ...
    Created on : Apr 9, 2019, 4:30:20 PM
    Author     : Integos
--%>
...
Smartphone Compatible web template, free webdesigns for Nokia, Samsung, LG, SonyEricsson, Motorola web design" />
	...
	if(address.length==0)
	{
        ...
        var fcontact=  document.getElementById("txtcontact1").value;
	...
	if(fcontact.length==0)
	{
		...
		return false;
         ...
         var scontact=  document.getElementById("txtcontact2").value;
...
<body>
	...
	<div class="contact-w3l">
		<div class="container">
			<!-- tittle heading -->
			<h3 class="tittle-w3l">Edit Profile
			...
			<div class="contact agileits">
				<div class="contact-agileinfo">
					<div class="contact-form wthree">
						<form action="../SupplierEditProfileAction" method="post">
                                                    
                                                    <%
                                                      
                                                         String sql="select * from supplier_tb where supplier_id='"+session.getAttribute("id")+"'";
                                            ResultSet rs=dm.ForSelect(sql);
                                            if(rs.next())
                                            {
                                                        %>
                                                        <input type="hidden" name="hdnid" id="hdnid"  value="<%=rs.getString(1)%>"> 
                                                        
							<div class="">                                                   
                         <input type="text" name="txtfullname" id="txtfullname" placeholder="FullName" required="" value="<%=rs.getString(2)%>"> 
                         
							</div>
                         <div class="">
                           <textarea class="form-control" name="txtcadddr" id="txtcadddr" placeholder="Address" required=""><%=rs.getString(3)%></textarea>
                         </div>
							<div class="">
							...
							<div class="">
								<input type="text" name="txtcontact1" id="txtcontact1" placeholder="Contact Number
                                                                       " required="" value="<%=rs.getString(4)%>">
							</div>
                                                        <div class="">
								<input type="text" name="txtcontact2" id="txtcontact2" placeholder="Contact Number
                                                                       " required="" value="<%=rs.getString(5)%>">
							</div>
							<input type="submit" value="Edit My Profile" onclick="return SuppliersValidation();">
