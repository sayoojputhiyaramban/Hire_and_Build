...
Smartphone Compatible web template, free webdesigns for Nokia, Samsung, LG, SonyEricsson, Motorola web design" />
	...
	//var f=document.reg.Gender[1].checked;
         ...
         var name=  document.getElementById("txtqty").value;
...
<body>
	...
	<div class="contact-w3l">
		<div class="container">
			<!-- tittle heading -->
			<h3 class="tittle-w3l">Edit  Stock 
			...
			<div class="contact agileits">
				<div class="contact-agileinfo">
					<div class="contact-form wthree">
						<form action="../SupplierEditStockAction" method="post">
                                                    
                                                    <%
                                                      
                                                        String sqlResource="select * from add_supplier_resource_tb where sresource_id='"+request.getParameter("id")+"' ";
                        ResultSet rs=dm.ForSelect(sqlResource);
                        if(rs.next())
                        {%>
                                                        <input type="hidden" name="hdnid" id="hdnid"  value="<%=rs.getString(1)%>"> 
                                                        
							<div class="">                                                   
                         Quantity <input type="text" name="txtqty" id="txtqty" placeholder="Name" required="" value="<%=rs.getString(2)%>"> 
                         
							</div>
                         <div class="">
                             Amount
                           <input type="text"  name="txtamt" id="txtamt" placeholder="Address" required="" value="<%=rs.getString(3)%>">
                         </div>
							<div class="">
							...
							<div class="">
                                                            Travel Cost
								<input type="text" name="txtcost" id="txtcost" placeholder="Contact Number
                                                                       " required="" value="<%=rs.getString(4)%>">
							</div>
                                                      
							<input type="submit" value="Edit Stock" onclick="return SuppliersValidation();">
