...
<head>
	...
	<!-- Bootstrap-Core-CSS -->
	<!-- gallery  -->
	<link href="district-web_Free03-09-2018_876381332/web/css/prettyPhoto.css" rel="stylesheet" type="text/css" />
...
<body>
	...
	<section class="wthree-row w3-gallery py-5">
		<div class="container py-xl-5 py-lg-3">
			...
			<ul class="portfolio-categ filter mb-5 pb-4 text-center border-bottom">
				...
				<li class="cat-item-1">
					<a href="#" title="Category 1">HeavyEquipments</a>
				</li>
				<li class="cat-item-2">
					<a href="#" title="Category 2">Trolly/Mixers</a>
				</li>
				<li class="cat-item-3">
					<a href="#" title="Category 3">scaffolding</a>
				</li>
			...
			<ul class="portfolio-area clearfix">
				<li class="portfolio-item2" data-id="id-1" data-type="cat-item-1">
					<span class="image-block">
						<a class="image-zoom" href="district-web_Free03-09-2018_876381332/web/images/ab1.jpg" data-gal="prettyPhoto[gallery]">
							<img src="district-web_Free03-09-2018_876381332/web/images/ab1.jpg" class="img-fluid w3layouts agileits" alt="Traventure">
						</a>
					</span>
				</li>
				<li class="portfolio-item2" data-id="id-2" data-type="cat-item-2">
					<span class="image-block">
						<a class="image-zoom" href="district-web_Free03-09-2018_876381332/web/images/ab2.jpg" data-gal="prettyPhoto[gallery]">
							<img src="district-web_Free03-09-2018_876381332/web/images/ab2.jpg" class="img-fluid w3layouts agileits" alt="Traventure">
						</a>
					</span>
				</li>
				<li class="portfolio-item2" data-id="id-2" data-type="cat-item-2">
					<span class="image-block">
						<a class="image-zoom" href="district-web_Free03-09-2018_876381332/web/images/cement_mixer.jpg" data-gal="prettyPhoto[gallery]">
							<img src="district-web_Free03-09-2018_876381332/web/images/cement_mixer.jpg" class="img-fluid w3layouts agileits" alt="Traventure">
						</a>
					</span>
				</li>
				<li class="portfolio-item2" data-id="id-4" data-type="cat-item-4">
					<span class="image-block">
						<a class="image-zoom" href="district-web_Free03-09-2018_876381332/web/images/transit_mixer.jpg" data-gal="prettyPhoto[gallery]">
							<img src="district-web_Free03-09-2018_876381332/web/images/transit_mixer.jpg" class="img-fluid w3layouts agileits" alt="Traventure">
						</a>
					</span>
				</li>
				<li class="portfolio-item2" data-id="id-1" data-type="cat-item-1">
					<span class="image-block">
						<a class="image-zoom" href="district-web_Free03-09-2018_876381332/web/images/blog3.jpg" data-gal="prettyPhoto[gallery]">
							<img src="district-web_Free03-09-2018_876381332/web/images/blog3.jpg" class="img-fluid w3layouts agileits" alt="Traventure">
						</a>
					</span>
				</li>
				<li class="portfolio-item2" data-id="id-6" data-type="cat-item-6">
					<span class="image-block">
						<a class="image-zoom" href="district-web_Free03-09-2018_876381332/web/images/blog4.jpg" data-gal="prettyPhoto[gallery]">
							<img src="district-web_Free03-09-2018_876381332/web/images/blog4.jpg" class="img-fluid w3layouts agileits" alt="Traventure">
						</a>
					</span>
				</li>
				<li class="portfolio-item2" data-id="id-4" data-type="cat-item-3">
					<span class="image-block">
						<a class="image-zoom" href="district-web_Free03-09-2018_876381332/web/images/scaffolding.jpg" data-gal="prettyPhoto[gallery]">
							<img src="district-web_Free03-09-2018_876381332/web/images/scaffolding.jpg" class="img-fluid w3layouts agileits" alt="Traventure">
						</a>
					</span>
				</li>
				<li class="portfolio-item2" data-id="id-4" data-type="cat-item-4">
	...
	<div class="copy_right py-4 text-center">
		<p class="text-white">2019 Resource Scheduler </p>
	</div>
	<!-- //copyright -->
	...
	<script src="district-web_Free03-09-2018_876381332/web/js/jquery-1.7.2.js"></script>
	<script src="district-web_Free03-09-2018_876381332/web/js/jquery.quicksand.js"></script>
	<script src="district-web_Free03-09-2018_876381332/web/js/script.js"></script>
	<script src="district-web_Free03-09-2018_876381332/web/js/jquery.prettyPhoto.js"></script>
	<!-- //jQuery-Photo-filter-lightbox-Gallery-plugin -->
	<!-- //Js files -->
