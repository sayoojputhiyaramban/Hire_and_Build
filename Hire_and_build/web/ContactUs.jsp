<%-- 
    Document   : ContactUs
    Created on : Apr 12, 2019, 10:50:03 AM
    Author     : Integos
--%>
...
<body>
		...
		<div class="banner-w3ltext about-w3bnr">
			<div class="container">
				<h1 class="text-white text-center">
					<a href="index.jsp">Home</a> / Contact Us</h1>
			</div>
		</div>
		<!-- //banner-text -->
	</div>
			...
			<div class="row contact-form py-3">
				...
				<div class="col-lg-6 map text-center">
					<h4>Our world wide range of Branches </h4>
                                        <img src="district-web_Free03-09-2018_876381332/web/images/map.jpg" alt="" class="img-fluid" />
				</div>
				<!-- //contact map -->
				<!-- contact form -->
	...
	<div class="footer-top py-5 text-center">
		<div class="container py-xl-5 py-lg-3">
			<h2 class="text-white mb-4">Make Your Dream </h2>
