...
<body>
				...
				<nav class="navbar navbar-default">
					<div class="container-fluid">
						...
						<!-- Collect the nav links, forms, and other content for toggling -->
                                        ...
                                        <jsp:include page="header_shoppy.jsp" />
	...
	<div class="contact-w3l">
		<div class="container">
			<!-- tittle heading -->
			<h3 class="tittle-w3l">Update Password
			...
			<div class="contact agileits">
				<div class="contact-agileinfo">
					<div class="contact-form wthree">
						<form action="ForgotPasswordUpdateAction?id=<%=request.getParameter("id")%>&type=<%=request.getParameter("type")%>" method="post">
							<div class="">                                                   
                         <input type="text" name="txtnewpswd" id="txtnewpswd" placeholder="New Password" required="">
                         
							</div>
                         <div class="">
                             <input type="text" name="txtconfirmpswd" id="txtconfirmpswd" placeholder="Confirm Password" required="">
                         </div>
							<div class="">
