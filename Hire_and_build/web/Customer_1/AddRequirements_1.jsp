<%-- 
    Document   : ApproveSuppliers
    Created on : Apr 4, 2019, 1:34:13 PM
    Author     : Integos
--%>
...
<body>
	...
	<div class="faqs-w3l">
		<div class="container">
			<!-- tittle heading -->
                        ...
                        <%
                            String sqlOrder="select resourceorder_tb.*,adddamage_details_tb.* from resourceorder_tb inner join adddamage_details_tb on resourceorder_tb.order_id=adddamage_details_tb.order_id where customer_id='"+session.getAttribute("id")+"' and payment_status='Pending' ";
    ...
    <marquee style="font-family:Cursive;font-size:10pt;color:red;height:50px;" scrollamount="3"     behavior="scroll" direction="right" onmouseover="this.stop();" onmouseout="this.start();"> <a href="ViewDamageDetails.jsp?order_id=<%=rsOrder.getString(1)%>"> Damaged Payment Amount for the order <%=rsOrder.getString(1)%> </a></marquee>
			...
			<h3 class="tittle-w3l">Add Requirements
		...
		<div class="container py-xl-5 py-lg-3">
			...
			<div class="row contact-form py-3">
				...
				<div class="col-lg-6 map text-center">
					<h4>Add   All  Resource Requirements   </h4>
					<img src="../district-web_Free03-09-2018_876381332/web/images/ab1.jpg" alt="" class="img-fluid" />
				</div>
				<!-- //contact map -->
				<!-- contact form -->
				<div class="col-lg-6 wthree-form-left mt-lg-0 mt-5">
					<div class="contact-top1">
                                            <form action="../AddRequirementsAction" method="post" class="f-color" >
							<div class="form-group">
								<label>Resource</label>
								<select class="contact-formw3ls form-control" name="ddlres" id="ddlres" required>
                                                                      <option value="0"> Select Resource</option>
                                                                     <%  
                                  
                        String sql="select * from addresoucemain_tb ";
                         ...
                         %>
                          ...
                          <div class="form-group">
								<label>Required Quantity</label>
                                                                ...
                                                                <select class="contact-formw3ls form-control" name="ddlqty" id="ddlqty" required>
                                                                    <% for(int i=1;i<=250;i++)
                                                                    {%>
								...
								<label>From Date</label>
                                                                ...
                                                                <input type="date" class="contact-formw3ls form-control" name="from_date" id="from_date" />
							</div>
                                                                 <div class="form-group">
								<label>To Date</label>
								
                                                                <input type="date"  class="contact-formw3ls form-control" name="to_date" id="to_date" />
							</div>
                                                      
							
							<!--<div class="form-group">
								<label>Description</label>
								<textarea class="contact-formw3ls form-control" rows="5" id="txtdesc" name="txtdesc" required></textarea>
							</div>
                                                          <div class="form-group">
								<label>Upload</label>
								<input type="file" class="contact-formw3ls form-control" name="file" id="file" required />
							</div>-->
							<input type="submit" class="btn submit contact-submit" value="Add My Requirements" />
						</form>
					</div>
				</div>
				<!-- //contact form -->
