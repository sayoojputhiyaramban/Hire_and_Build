<%-- 
    ...
    Created on : Apr 30, 2019, 4:42:41 PM
    Author     : Integos
--%>
...
Smartphone Compatible web template, free webdesigns for Nokia, Samsung, LG, SonyEricsson, Motorola web design" />
	...
	<div class="privacy">
		<div class="container">
			<!-- tittle heading -->
			<h3 class="tittle-w3l"> Bill Details
        ...
        <%
           ...
           String sqlRequirements="select * from resourceorder_tb where order_id='"+order_id+"'";
                                            ...
                                            %>       
                                                ...
                                                <%
                                                    ...
                                                    order_id=rsRequirements.getString("order_id");
                                                ...
                                                String sqlSupp="select * from supplier_tb where supplier_id='"+supplier_id+"'";
                                                
                                                ResultSet rsSupp=dm.ForSelect(sqlSupp);
                                                if(rsSupp.next())
                                                {
                                                        ...
                                                        <tr> <td>Supplier Name</td> <td> <%=rsSupp.getString(2)%> </td></tr>
							<tr class="rem1">
                                                            <td>Order ID</td>
                                                            <td class="invert"><%=rsRequirements.getString(1) %> </td> </tr>
                                                        <tr><td>Resource Name</td>
								<td class="invert"><%=rs.getString(2) %> </td> </tr>
								...
								<td class="invert-image">
										...
										<img src="../admin/ResouceUploads/<%= rs.getString("Uploads")%>" alt=" " class="img-responsive">
                                                                ...
                                                                <tr>
                                                                     <td>Quantity</td>
								<td class="invert"><%=rsRequirements.getString("required_qty") %></td></tr>
                                                                <tr>
                                                                   <td>From Date</td>
                                                                <td class="invert"><%=rsRequirements.getString("from_date") %></td></tr>
                                                                <tr>
                                                                    <td>To Date</td>
								<td class="invert"><%=rsRequirements.getString("to_date") %></td></tr>
                                                                <tr>
                                                                    <td>Total Cost</td>
                                                                <td class="invert"><%=rsRequirements.getString("totalCost") %></td></tr>
                                                ...
                                                <input type="button" value="Print My Bill" id="btnPrint" />
