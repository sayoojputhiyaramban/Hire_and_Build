...
<body>
	...
	<div class="ads-grid">
		<div class="container">
			<!-- tittle heading -->
			<h3 class="tittle-w3l"> Supplier Details
			...
			<div class="agileinfo-ads-display col-md-9 w3l-rightpro">
				<div class="wrapper">
					<!-- first section -->
                                         ...
                                         <%
                                            String sql="select * from supplier_tb where status='Approved' and supplier_id='"+request.getParameter("supplier_id")+"'";
						...
						<div class="col-xs-4 product-men">
							...
							<div class="men-pro-item simpleCart_shelfItem">
								...
								<div class="item-info-product ">
									<h4>
										<a href="single2.html"> <%=rs.getString(2)%></a>
									</h4>
									<div class="info-product-price">
                                                                            Place: 
                                                                                
                                                                                 <span class="item_price"><%=rs.getString(10)%></span><br>
                                                                            Contact:<br>
										<span class="item_price"><%=rs.getString(4)%></span><br>
                                                                                <span class="item_price"><%=rs.getString(5)%></span><br>
									...
									<div class="snipcart-details top_brand_home_details item_add single-item hvr-outline-out">
										<form action="ViewSuppliersResource.jsp?id=<%=rs.getString(1)%>" method="post">
											<fieldset>
												...
												<input type="submit" name="submit" value="Equipment List" class="button" />
											</fieldset>
										</form>
									</div>
