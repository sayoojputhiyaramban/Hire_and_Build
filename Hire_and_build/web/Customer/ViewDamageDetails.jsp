...
<body>
	...
	<div class="privacy">
		<div class="container">
			<!-- tittle heading -->
			<h3 class="tittle-w3l">View Orders Details
			...
			<div class="checkout-right">
				...
				<div class="table-responsive">
					<table class="timetable_sub">
                                            ...
                                            <%
                                                String Customer_id="";
                                                String sqlRequirements="select * from resourceorder_tb where order_id='"+request.getParameter("order_id")+"' ";
							...
							<!--	<td class="invert">
									<div class="rem">
										<!--<div class="close1"> </div>-->
                                             ...
                                             <a href="AddDamage_Details.jsp?order_id=<%=rsRequirements.getString(1)%>">Any Damage 
				...
				<div class="contact-agileinfo">
					<div class="contact-form wthree">
                                                 ...
                                                 String sqlCustomers="select * from adddamage_details_tb where order_id='"+request.getParameter("order_id")+"' ";
                                                
                                                ResultSet rsCustomers=dm.ForSelect(sqlCustomers);
                                                if(rsCustomers.next())
                                                {
                                                    damageID= rsCustomers.getString(1);
                                                    rate=rsCustomers.getInt(3);
                                                    
                                                %>
                                                <h3 class="tittle-w3l"> Damage Details</h3>
							<div class="">
                                                            Damage Details :  <textarea  name="message"  readonly="true" ><%=rsCustomers.getString(2)%>	</textarea> 
							</div>
							<div class="">
								Damage Rate <input type="text" name="name" value=" <%=rsCustomers.getString(3)%>" readonly="true" />
							</div>
							<div class="">
								Last Date of Payment <input class="email" type="email" name="email" value=" <%=rsCustomers.getString(4)%>"  readonly="true" />
							</div>
							<div class="">
								 Payment Status: <input type="text" name="name" value=" <%=rsCustomers.getString(6)%>"readonly="true" />
							</div>
    ...
    <input type="hidden" name="item_number" value="<%=request.getParameter("order_id")%>">
   ...
   <input type="hidden" name="return" value="http://localhost:8084/Construction_Resource_Scheduler/Customer/success_DamagePayment.jsp?damage_ID=<%=damageID%>&total=<%=rate%>">
