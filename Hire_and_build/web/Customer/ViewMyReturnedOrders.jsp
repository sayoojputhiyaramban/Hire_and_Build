				...
				<div class="table-responsive">
					<table class="timetable_sub">
                                            ...
                                            <%
                                                ...
                                                String supplier_id="",order_id="";
                                                String sqlRequirements="select * from resourceorder_tb where customer_id='"+session.getAttribute("id")+"' and (status='Returned' or status='Damaged') order by order_id desc";
							...
							<!--	<td class="invert">
									<div class="rem">
										<!--<div class="close1"> </div>-->
                                             ...
                                             <a href="GenerateBill.jsp?supplier_id=<%=supplier_id%>&order_id=<%=rsRequirements.getString(1)%> ">Details
