...
<body>
	...
	<div class="privacy">
		<div class="container">
			<!-- tittle heading -->
			<h3 class="tittle-w3l">View Resource Damage Payment Status
				...
				<div class="table-responsive">
					<table class="timetable_sub">
                                            ...
                                            <%
                                                ...
                                                String statusUpdate="update adddamage_details_tb set payment_status='Done' where damage_id='"+request.getParameter("damage_ID")+"'";
                                                int rStatus=dm.ForInsert(statusUpdate);
                                                if(rStatus>0)
                                                {
                                                    out.print("<script type='text/javascript'>alert('Payment has been done successfully'); </script>");
                                                }
                                                
                                                
                                                
                                                String sqlRequirements="select * from adddamage_details_tb where damage_id='"+request.getParameter("damage_ID")+"' ";
                                                
                                                ResultSet rsRequirements=dm.ForSelect(sqlRequirements);
                                                if(rsRequirements.next())
                                                {
                                            
                                                     String sqlOrder="select * from resourceorder_tb where order_id='"+rsRequirements.getString("order_id")+"' ";
                                                
                                                ResultSet rsOrders=dm.ForSelect(sqlOrder);
                                                if(rsOrders.next())
                                                {
						...
						<thead>
							<tr>
								...
								<th>Total Cost</th>
                                                ...
                                                String sql="select * from addresoucemain_tb where resource_id='"+rsOrders.getString(2)+"'";
							...
							<tr class="rem1">
                                                            <td class="invert"><%=rsRequirements.getString("order_id") %> </td>
								...
								<td class="invert"><%=rsOrders.getString("required_qty") %></td>
                                                                <td class="invert"><%=rsOrders.getString("from_date") %></td>
								<td class="invert"><%=rsOrders.getString("to_date") %></td>
                                                                <td class="invert"><%=rsOrders.getString("totalCost") %></td>
							...
							<!--	<td class="invert">
									<div class="rem">
										<!--<div class="close1"> </div>-->
                                             ...
                                             <a href="SearchResourceAction.jsp?reqid=<%=rsRequirements.getString(1)%>">Process It
