			...
			<div class="agileinfo-ads-display col-md-9 w3l-rightpro">
				<div class="wrapper">
					<!-- first section -->
                                         ...
                                         <%
                                            String sql="select * from add_supplier_resource_tb where supplier_id='"+request.getParameter("id")+"'";
                                            ...
                                            while(rs.next())
                                            {
                                                String Resource_id=rs.getString(5);
					...
					<div class="product-sec1">
						<div class="col-xs-4 product-men">
							...
							<div class="men-pro-item simpleCart_shelfItem">
								<div class="men-thumb-item">
                                                                     <% 
                                                String sql_Image="select * from addresoucemain_tb where Resource_id='"+Resource_id+"'";
                                                ResultSet rs_Image=dm.ForSelect(sql_Image);
                                                if(rs_Image.next()) 
                                                {
                                                                     %>
                                                                   
									<img src="../admin/ResouceUploads/<%= rs_Image.getString(4)%>" alt="">
								...
								<div class="item-info-product ">
									<h4>
										Available Stock: <%=rs.getString(2)%>
									</h4>
									<div class="info-product-price">
                                                                           
                                                                                
                                                                                 <span class="item_price">Amount Per Day: <%=rs.getString(3)%></span><br>
                                                                          
                                                                                
										
									</div>
									<div class="snipcart-details top_brand_home_details item_add single-item hvr-outline-out">
										<form action="ViewSuppliersResource.jsp?id=<%=rs.getString(1)%>" method="post">
											<fieldset>
						...
						<div class="col-xs-4 product-men">
							<div class="men-pro-item simpleCart_shelfItem">
								<div class="men-thumb-item">
									 <% 
                                                sql_Image="select * from addresoucemain_tb where Resource_id='"+Resource_id+"'";
                                                rs_Image=dm.ForSelect(sql_Image);
                                                if(rs_Image.next()) 
                                                {
                                                                     %>
									<img src="../admin/ResouceUploads/<%= rs_Image.getString(4)%>" alt="">
						...
						<div class="clearfix"></div>
                                            ...
                                            {
                                                out.println("Equipment List is empty");
                                            }
                                            %>
                                            </div>
