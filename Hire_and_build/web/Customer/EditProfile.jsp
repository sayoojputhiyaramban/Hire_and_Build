			...
			<div class="contact agileits">
				<div class="contact-agileinfo">
					<div class="contact-form wthree">
						<form action="../CustomerEditProfileAction" method="post">
                                                    
                                                    <%
                                                      
                                                         String sql="select * from customer_tb where customer_id='"+session.getAttribute("id")+"'";
                         ...
                         <div class="">
                           <textarea class="form-control" name="txtcadddr" id="txtcadddr" placeholder="Address" required=""><%=rs.getString(3)%></textarea>
							...
							<div class="">
								<input type="text" name="txtcontact" id="txtcontact" placeholder="Contact Number
                                                                       " required="" value="<%=rs.getString(4)%>">
							</div>
							<input type="submit" value="Edit My Profile" onclick="return CustomersValidation();">
