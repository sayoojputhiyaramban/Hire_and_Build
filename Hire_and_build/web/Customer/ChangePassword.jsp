			...
			<div class="contact agileits">
				<div class="contact-agileinfo">
					<div class="contact-form wthree">
						<form action="../CustomerChangePasswordAction" method="post">
                                               
                                                      
                                                        <div class="">                                                   
                                                            <tt>  <input type="password" name="txtcrnt" id="txtcrnt" placeholder="Current Password" required="" /> </tt> <br/><br/>
                         
							</div>
                                                        
							 <div class="">                                                   
                                                             <tt>   <input type="password" name="txtnew" id="txtnew" placeholder="New Password" required="" /> </tt> <br/><br/>
                         
							</div>
                        <div class="">                                                   
                            <tt>   <input type="password" name="txtconf" id="txtconf" placeholder="Confirm Password" required="" /> </tt> <br/><br/>
