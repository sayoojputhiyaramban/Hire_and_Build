...
<body>
	...
	<div class="privacy">
		<div class="container">
			<!-- tittle heading -->
			<h3 class="tittle-w3l">Distance Details
			...
			<div class="checkout-right">
				...
				<div class="table-responsive">
					<table class="timetable_sub">
                                            ...
                                            <%
                                                String sqlDistance="select * from distance_tb ";
                                                
                                                ResultSet rsDistance=dm.ForSelect(sqlDistance);
                                                if(rsDistance.next())
                                                {%>       
						...
						<thead>
							...
							<tr class="rem1">
								<td class="invert"><%=rsDistance.getString(2) %> </td>
								...
								<td class="invert"><%=rsDistance.getString(3) %></td>
                                                                <td class="invert"><%=rsDistance.getString(4) %></td>
								...
								<td class="invert">
									<div class="rem">
										<div class="close3"> </div>
                                                ...
                                                {
                                                    out.println("Distance List is empty");
                                                }
