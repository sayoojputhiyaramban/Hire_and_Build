	  			...
	  			<div class="col-lg-6 col-md-8 col-sm-9">
	  				...
	  				<nav class="tm-nav">
						<ul>
                                                    ...
                                                    <li><a href="ViewRequirements.jsp">View Requirements</a></li>
  ...
  <label>
      <font color=pink><font size="3">Start</font> <br />
        ...
        <label>
              ...
              <input id="routeEnd" name="key" required="required" type="text" readonly="true" value="<%=request.getParameter("loc")%>" placeholder="ENTER DESTINATION PLACE" style="width: 400px;margin-left: 50px;height: 30px;border-radius: 50px;font-size: 15px;text-align: center" /><br><br>
            </center>
  </label>
                        <center>
