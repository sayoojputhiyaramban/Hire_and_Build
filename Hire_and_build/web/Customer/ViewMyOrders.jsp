...
<body>
	...
	<div class="privacy">
		<div class="container">
			<!-- tittle heading -->
			<h3 class="tittle-w3l">View Order Status
			...
			<div class="checkout-right">
				...
				<div class="table-responsive">
					<table class="timetable_sub">
                                            ...
                                            <%
                                                String supplier_id="";
                                                String sqlRequirements="select * from resourceorder_tb where customer_id='"+session.getAttribute("id")+"' and status!='Approved' order by order_id desc";
						...
						<thead>
							...
							<tr class="rem1">
								...
								<td class="invert"><%=rsRequirements.getString("to_date") %></td>
                                             ...
                                             <a href="ViewOrderSuppliers.jsp?supplier_id=<%=supplier_id%>">Details
