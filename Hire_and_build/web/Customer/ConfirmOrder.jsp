...
<body>
					...
					<!-- first section -->
                                         ...
                                         <%
                                             ...
                                             String Requirement_id=request.getParameter("Requirement_id");
                                              ...
                                              String sqlBL="select * from blacklist_tb where customer_id='"+session.getAttribute("id")+"' and supplier_id='"+supplier_id+"'" ;
                                             ResultSet rsBL=dm.ForSelect(sqlBL);
                                              if(rsBL.next())
                                             {
                                                 %>
                                                 ...
                                                 <script type="text/javascript">
                                                     ...
                                                     alert("You are in Black List ... Either Complete Due Payment or Contact Supplier ");
                                                     window.location="ViewRequirements.jsp";
                                             ...
                                             //String sqlRequirements="select * from resourcerequirement_tb where customer_id='"+session.getAttribute("id")+"'" ;
                                              String sqlRequirements="select * from resourcerequirement_tb where customer_id='"+session.getAttribute("id")+"' and requirement_id='"+Requirement_id+"'" ;
                                             ...
                                             from_date=rsRequirements.getString(7);
                                             to_date=rsRequirements.getString(7);
                                     ...
                                     <form action="PayPalRentBooking.jsp?id=<%=supplier_id%>&Resourceid=<%=Resourceid%>&requirement_id=<%=Requirement_id%>&days=<%=days%>" method="post" name="frmPayPal1">   
						...
						<div class="col-xs-4 product-men">
							...
							<div class="men-pro-item simpleCart_shelfItem">
								...
								<div class="item-info-product ">
									<h4>
                                                                            <label>	<a href=""> <%=rsSupplier.getString(2)%></a></label>
									</h4>
									<div class="info-product-price">
										...
										<span class="item_price"  style="font-family:verdana" ><%=rsSupplier.getString(4)%></span><br>
                                                                           ...
                                                                           <i class="fa fa-refresh" aria-hidden="true"></i> In Stock
                                                                                 <span class="item_price" style="font-family:verdana"><%=rsDays.getString("quantity")%></span><br>
                                                                              Cost per day
                                                                                 <span class="item_price" style="font-family:verdana"><%=rsDays.getString("amount")%></span><br>
                                                                                 
                                                                               Required Quantity :  <span class="item_price" style="font-family:verdana"> <input type="text" name="txtreq" id="txtreq" value="<%=required_qty%>"/></span> <br>
                                                                               Need Delivery Service : <br> <span class="item_price" style="font-family:verdana"> <input type="radio" name="radService" id="radService" value="y" />Y <input type="radio" name="radService" id="radService" value="n" checked="checked" />N</span> <br>
                                                                              ...
                                                                              <i class="fa fa-hand-o-right" aria-hidden="true"></i>   Total cost for <%=days%> days :
                                                                                   ...
                                                                                   <span class="item_price" style="font-family:verdana"><%= rsDays.getString("travel_cost") %></span><br>
   ...
   <!-- <input type="hidden" name="business" value="<%=paypal_id %>">
    ...
    <input type="hidden" name="return" value="http://localhost:8084/Construction_Resource_Scheduler/Customer/success.jsp">
   <!-- <input type="image" src="https://www.sandbox.paypal.com/en_US/i/btn/btn_buynowCC_LG.gif" border="0" name="submit" alt="PayPal - The safer, easier way to pay online!">-->
    <!--<img alt="" border="0" src="https://www.sandbox.paypal.com/en_US/i/scr/pixel.gif" width="1" height="1">-->
   
												<input type="submit" name="submit" value="ConfirmOrder" class="button" />
