<%-- 
    ...
    Created on : May 4, 2019, 11:12:19 AM
    Author     : Integos
--%>
...
Smartphone Compatible web template, free webdesigns for Nokia, Samsung, LG, SonyEricsson, Motorola web design" />
	...
	<div class="privacy">
		<div class="container">
			<!-- tittle heading -->
			<h3 class="tittle-w3l"> Supplier Account Details
        ...
        <%
           ...
           String sqlRequirements="select * from supplier_tb where supplier_id='"+supplier_id+"'";
                                            ...
                                            %>       
                                                ...
                                                <tbody>
                                                        ...
                                                        <tr> <td>Supplier Name</td> <td> <%=rsRequirements.getString(2)%> </td></tr>
							<tr class="rem1">
                                                            <td>Address</td>
                                                            <td class="invert"><%=rsRequirements.getString(3) %> </td> </tr>
                                                        <tr><td>Contact number1</td>
								<td class="invert"><%=rsRequirements.getString(4) %> </td> </tr>
                                                          <tr><td>Contact number2</td>
								<td class="invert"><%=rsRequirements.getString(5) %> </td> </tr>
                                                        <tr>
                                                           <td>Proof</td>
                                                            
								<td class="invert-image">
									
										<img src="../Uploads/<%= rsRequirements.getString("proof")%>" alt=" " class="img-responsive">
									
								</td> </tr>
								
                                                                <tr>
                                                                     <td>Place</td>
								<td class="invert"><%=rsRequirements.getString(10) %></td></tr>
                                                ...
                                                {
                                                    out.println("Supplier List is empty");
                                                }
