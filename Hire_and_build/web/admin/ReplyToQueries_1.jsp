<%-- 
    Document   : ReplyToQueries
    Created on : Apr 18, 2019, 10:10:04 AM
    Author     : Integos
--%>
...
<body>
	...
	<div class="contact-w3l">
		<div class="container">
			<!-- tittle heading -->
			<h3 class="tittle-w3l">Reply To Query
			...
			<div class="contact agileits">
				<div class="contact-agileinfo">
					<div class="contact-form wthree">
						<form action="../ReplyToQueriesAction" method="post">
                                                    
                                                    <%
                                                      
                                                         String sql="select * from queries_to_admin_tb where query_id='"+request.getParameter("id")+"'";
                                            ResultSet rs=dm.ForSelect(sql);
                                            if(rs.next())
                                            {
                                                        %>
                                                        <input type="hidden" name="hdnqid" id="hdnqid"  value="<%=rs.getString(1)%>"> 
                                                        
							
                         <div class="">
                           <textarea class="form-control" name="txtreply" id="txtreply" placeholder="Reply .." required=""></textarea>
                         </div>
