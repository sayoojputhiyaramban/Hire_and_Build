...
<body>
	...
	<div class="contact-w3l">
		<div class="container">
			<!-- tittle heading -->
			<h3 class="tittle-w3l">Add Distance
			...
			<div class="contact agileits">
				<div class="contact-agileinfo">
					<div class="contact-form wthree">
						<form action="../AddDistanceAction" method="post">
							<div class="">
                       ...
                       while(rs.next())
                        ...
                        <%
                         ...
                         %>
                          ...
                          <select name="ddldestination" id="ddldestination" >
                                                                
                                                                 <option value="0"> -- Destination --</option>
                                                                     <%  
                                  
                         sql="select * from place_tb ";
                        rs=dm.ForSelect(sql);
                       while(rs.next())
                        {
                        %>
                        ...
                        <%
                         ...
                         <div class="">
							...
							<div class="">
								<input type="text" name="txtdist" id="txtdist" placeholder="Distance" required="">
							</div>
