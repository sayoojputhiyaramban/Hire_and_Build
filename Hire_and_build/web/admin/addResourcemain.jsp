			...
			<div class="contact agileits">
				<div class="contact-agileinfo">
					<div class="contact-form wthree">
                                             ...
                                             <form action="../addResourceMainAction" method="post" class="f-color" enctype="multipart/form-data">
							<div class="form-group">
								<label>Resource</label>
								<input type="text" class="contact-formw3ls form-control" name="txtres" id="txtres" required>
							</div>
							<!--<div class="form-group">
								<label>Type</label>
