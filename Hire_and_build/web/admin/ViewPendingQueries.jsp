...
<body>
	...
	<div class="contact-w3l">
		<div class="container">
			<!-- tittle heading -->
			<h3 class="tittle-w3l">Queries From Supplier
					...
					<div class="contact-form wthree">
						<form action="../QueriesToAdminAction" method="post">
							...
							<div class="">
                                                            ...
                                                            <%
                                                                  String sql="select * from queries_to_admin_tb where status='Pending'";
                                            ...
                                            if(rs.next())
                                            {
                                                ...
                                                <tr>
                                                                    ...
                                                                    <td><a href="ReplyToQueries.jsp?id=<%= rs.getString(1)%>">Give Reply</a></td>
                                            ...
                                            {
                                                out.println("No pending Queries");
                                            }%>
