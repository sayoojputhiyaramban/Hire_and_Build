...
<body>
	...
	<div class="faqs-w3l">
		<div class="container">
			<!-- tittle heading -->
			<h3 class="tittle-w3l">Approve/Reject Suppliers
			...
			<!--<div class="faq-w3agile">-->
                ...
                <fieldset>
                            <center>
                              <% String sql= "select * from supplier_tb where status='Pending'";
                        ResultSet rs=dm.ForSelect(sql);
                          if(rs.next())
                          {
                              %>
                              <table cellspacing="5" cellpading="5" border="5">
                                  <thead>
                               <tr>
                                     ...
                                     <td><%= rs.getString(3)%></td>
                                      <td><%= rs.getString(4)%></td>
                                       <td><%= rs.getString(5)%></td>
                                         ...
                                         <td> <img src="../Uploads/<%= rs.getString("proof")%>" width="130px" height="130px"/></td>
                                        
                                        <td><a href="../ApproveSupplier?id=<%= rs.getString(1)%>">Approve</a></td>
                                         <td><a href="../RejectSupplier?id=<%= rs.getString(1)%>">Reject</a></td>
                                         <td><a href="SupplierDetails.jsp?id=<%= rs.getString(1)%>">Details</a></td>
