<%-- 
    Document   : ViewMyWholeOrder_Commission
    Created on : May 4, 2019, 11:27:57 AM
    Author     : Integos
--%>
...
<body>
	...
	<div class="privacy">
		<div class="container">
			<!-- tittle heading -->
			<h3 class="tittle-w3l">View Approved Orders
				...
				<div class="table-responsive">
					<table class="timetable_sub">
                                            ...
                                            <%
                                                ...
                                                int jcb_commission=12 ;//(i.e 10 percentage)
                                                int digging_spade_commission=10;
                                                int tbl_chair_commission=5;
                                                
                                                int other_commission=2;
                                                
                                                int total=0,sum_total=0;
                                                
                                                String supplier_id="";
                                                String sqlRequirements="select * from resourceorder_tb where status!='Rejected'  order by order_id desc";
							   ...
							   <th>Resource</th>
								...
								<th>Total Cost</th>
                                                ...
                                                <%
                                                  ...
                                                  supplier_id=rsRequirements.getString("supplier_id");
                                                ...
                                                if(rs.next())
                                                {
                                                     if((rs.getString(2).equals("JCB")))
                                                     {
                                                    total=rsRequirements.getInt("totalCost");
                                                    total=(total*jcb_commission);
                                                     }
                                                     else if ((rs.getString(2).equals("Spade")) || (rs.getString(2).equals("Digging Spade")) || (rs.getString(2).equals("Basket")))
                                                     {
                                                          total=rsRequirements.getInt("totalCost");
                                                    total=(total*digging_spade_commission);
                                                         
                                                     }
                                                     else if ((rs.getString(2).equals("Tables")) || (rs.getString(2).equals("Chair")) )
                                                     {
                                                          total=rsRequirements.getInt("totalCost");
                                                    total=(total*digging_spade_commission);
							...
							<!--	<td class="invert">
									<div class="rem">
										<!--<div class="close1"> </div>-->
                                             ...
                                             <a href="SupplierDetails.jsp?id=<%=supplier_id%>">Details
