 ...
 * @author Integos
 */
public class ApproveOrderAction extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet ApproveOrderAction</title>");            
            out.println("</head>");
            out.println("<body>");
            ...
            {
               String sql="update resourceorder_tb  set status='Approved' where order_id='"+request.getParameter("order_id")+"' ";
            int r=dm.ForInsert(sql);
            if(r>0)
            {
                  out.print("<script type='text/javascript'>alert('Order has been Approved'); window.location='Supplier/ViewMyPendingOrders.jsp'; </script>");
            ...
            else if(status.equals("Rejected"))
            {
                ...
                String sql="update resourceorder_tb  set status='Rejected' where order_id='"+request.getParameter("order_id")+"' ";
            int r=dm.ForInsert(sql);
          ...
          int updated_qty=total_qty+req_qty;
           ...
           if(r>0)
            {
                     out.print("<script type='text/javascript'>alert('Order has been Rejected'); window.location='Supplier/ViewMyPendingOrders.jsp'; </script>");       
            }         
