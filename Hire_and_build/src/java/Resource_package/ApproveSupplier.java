...
public class ApproveSupplier extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet ApproveSupplier</title>");            
            out.println("</head>");
            out.println("<body>");
            
              String sql="update supplier_tb set status='Approved' where supplier_id='"+request.getParameter("id")+"' ";
            ...
            out.println("<h1>Servlet ApproveSupplier at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        } finally {            
            out.close();
